 ...
 *
 * Filters are the hooks that MiniYun launches to modify text of various types
 ...
 * </code>
 *
 * In MiniYun, hooked functions can take extra arguments that are set
 ...
 *
 * Actions are the hooks that the MiniYun core launches at specific points
...
function plugin_basename($file) {
	...
	$mu_plugin_dir = str_replace('\\','/',PLUGIN_DIR); // sanitize for Win32 installs
