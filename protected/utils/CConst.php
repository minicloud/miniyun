...
class CConst
{
    ...
    */
    ...
    const LAUNCH_SHARE_FOLDER         = 2; // 发起 共享文件夹
    const ACCEPT_SHARE_FOLDER         = 3; // 接受 共享文件夹
    
    //
    // 设备类型
    //
    const DEVICE_WEB                      = 1; // WEB
    ...
    // 应用中心远程地址
    //
    const APP_SITE_URL                    = "http://www.miniyun.cn"; // iphone/ipad
}
?>
