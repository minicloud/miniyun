...
class m120924_100748_base extends EDbMigration
{
    ...
    public function executeMigrate(){
        ...
        $this->insert(DB_PREFIX.'_clients', array("id"=>5,"user_id"=>-1,"client_name"=>"MiniyunAndroidPad",    "client_id"=>"V8G9svK8VDzezLum",    "client_secret"=>"waACXBybj9QXhE3a","redirect_uri"=>"","enabled"=>1,"description"=>"MiniyunAndroidPad","created_at"=>$data,"updated_at"=>$data));
