...
class phpCAS
{
    ...
    */
    ...
    public static function getAttributes()
    {
        phpCAS::_validateClientExists();
        try {
            // 对中文字符进行转码操作，否则中文字符信息显示乱码
            $attributeValues = self::$_PHPCAS_CLIENT->getAttributes();
    ...
    public static function getAttribute($key)
    {
        ...
        try {
            // 对获取到的参数进行urldecode转码，否则显示中文信息乱码
            return urldecode(self::$_PHPCAS_CLIENT->getAttribute($key));
        } catch (Exception $e) {
            phpCAS :: error(get_class($e) . ': ' . $e->getMessage());
        }
    }
